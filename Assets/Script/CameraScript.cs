...
public class CameraScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Quaternion target_rotationY = Quaternion.Slerp(Quaternion.Euler(0,transform.rotation.eulerAngles[1],0),Quaternion.Euler(0, yEuleur, 0),recenter_speed*Time.deltaTime*(prb.velocity.magnitude/2));
